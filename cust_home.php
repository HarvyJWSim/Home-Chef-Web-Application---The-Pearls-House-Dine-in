...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#reqHistory" id="reqHist">Request History</a>
            </li>
			<li class="nav-item">
    ...
    <header class="masthead" id="dashboard">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Hi Customer,</div>
          <div class="intro-lead-in">Welcome to Pearl House Dine-In</div>
		  <div class="intro-subheading" style="margin-bottom: 25px;">What are you waiting for? Start book your private chef now!</div>
		  <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="requestMenu.php">START</a>
        </div>
      </div>
	  <div class="container" style="background-color: rgba(255, 255, 255,0.7); border-radius: 15px; height: 450px; color: black;">
		  ...
		  <div class="row">
			  <div class="col-md-4">
				<div class="box">
					...
					<div class="row">
						<div class="col-md-6">
							<h1 style="color: coral" id="bookingNumPend">0</h1>
							<h6><i>pending</i></h6>
						</div>
						<vr></vr>
						<div class="col-md-6">
							<h1 style="color: coral" id="bookingNumComp">0</h1>
							<h6><i>completed</i></h6>
						</div>
					</div>
				</div>
			  ...
			  <div class="col-md-8">
				<div class="box">
					<h5 style="text-align: left; line-height: 25px">Countdown to next requested service</h5>
					<h1 style="color: coral; line-height: 45px;" id="countdown2Next">0</h1>
					<h6><i>next service in queue: 0</i></h6>
				</div>
			  </div>
		  </div>
		  <div class="row justify-content-md-center">
			  <div class="col-md-3">
				<div class="box2">
					<h4 style="text-align: left; line-height: 25px">Membership</h4>
					<h1 style="color: coral; line-height: 90px;" id="custMemShip">Normal</h1>
				</div>
			  </div>
			  <div class="col-md-6">
				<div class="box2">
					<h4 style="text-align: left; line-height: 25px">Last Requested Service</h4>
					<h1 style="color: coral;" id="lastServ">15 Dec 2017</h1>
					<h6><i>4 days ago</i></h6>
				</div>
			  </div>
		  </div>
	  </div>
    ...
    <!-- Services -->
    <section id="reqHistory" class="dynamic-content bg-mreq">
		<div class="container">
			<div class="row">
			  <div class="col-lg-12 text-center">
				<h2 class="section-heading text-uppercase">Request History</h2>
				<h3 class="section-subheading text-muted">History of service requested.</h3>
			  </div>
			</div>
					...
					<div class="panel-body">
						<div class="pull-right">
							<div class="btn-group" style="padding-right: 20px;">
								...
								<button type="button" class="btn btn-default btn-filter" data-target="all">Pending</button>
							</div>
						</div>
							  ...
							  <thead>
								...
								<tbody>
									 <tr>
										...
										<td><a href="#"><span class="fa fa-info-circle"></span></a> My Secret Menu # 1</td>
										<td>Booked</td>
										<td><a href="#" class="btn btn-danger btn-sm"><span class="fa fa-times"></span></a></td>
									</tr>
								</tbody>
							</table>
						</div>
  ...
  <script>
	  ...
	  var countDownDate = new Date("Dec 25, 2017 15:00:00").getTime();
	  ...
	  document.getElementById("countdown2Next").innerHTML = days + "d " + hours + "h "
	  + minutes + "m " + seconds + "s ";

	  // If the count down is finished, write some text
	  if (distance < 0) {
		clearInterval(x);
		document.getElementById("countdown2Next").innerHTML = "Service Time!";
	  }
	}, 1000);
  </script>
  </body>
